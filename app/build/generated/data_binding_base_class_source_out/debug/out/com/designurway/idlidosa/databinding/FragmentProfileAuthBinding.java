...
public final class FragmentProfileAuthBinding implements ViewBinding {
  @NonNull
  ...
  private FragmentProfileAuthBinding(@NonNull ScrollView rootView, @NonNull TextView addressTxt,
  ...
  @NonNull
  public static FragmentProfileAuthBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static FragmentProfileAuthBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.fragment_profile_auth, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static FragmentProfileAuthBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentProfileAuthBinding((ScrollView) rootView, addressTxt, emailTxt, nameTxt,
