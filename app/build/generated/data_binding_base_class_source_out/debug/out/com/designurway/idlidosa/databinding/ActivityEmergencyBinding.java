...
public final class ActivityEmergencyBinding implements ViewBinding {
  ...
  private ActivityEmergencyBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull EditText addPrescriptionEt, @NonNull Button newImg, @NonNull TextView orTv,
  ...
  public static ActivityEmergencyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.new_img;
      Button newImg = rootView.findViewById(id);
      if (newImg == null) {
        break missingId;
      }
      ...
      return new ActivityEmergencyBinding((ConstraintLayout) rootView, addItemsRl, addItmsRv,
          addPrescriptionEt, newImg, orTv, prescriptionQtnEt, sendMOrder, uploadImageTv,
