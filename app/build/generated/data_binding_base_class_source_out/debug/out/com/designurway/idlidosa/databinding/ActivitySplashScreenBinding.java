...
public final class ActivitySplashScreenBinding implements ViewBinding {
  ...
  private ActivitySplashScreenBinding(@NonNull RelativeLayout rootView,
      @NonNull CircleImageView appLogo, @NonNull TextView appName) {
  ...
  public static ActivitySplashScreenBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.app_logo;
      CircleImageView appLogo = rootView.findViewById(id);
      if (appLogo == null) {
        break missingId;
      }
      ...
      return new ActivitySplashScreenBinding((RelativeLayout) rootView, appLogo, appName);
    }
