...
public final class ActivityHomePageBinding implements ViewBinding {
  ...
  private ActivityHomePageBinding(@NonNull ConstraintLayout rootView,
      @NonNull BottomNavigationView bottomView, @NonNull FragmentContainerView homeNavHostFragment,
  ...
  public static ActivityHomePageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.homeNavHostFragment;
      FragmentContainerView homeNavHostFragment = rootView.findViewById(id);
      ...
      return new ActivityHomePageBinding((ConstraintLayout) rootView, bottomView,
          homeNavHostFragment, toolBar);
    }
