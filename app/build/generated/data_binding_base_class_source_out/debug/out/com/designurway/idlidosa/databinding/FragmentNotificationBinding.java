...
public final class FragmentNotificationBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView noificationListRecycler;

  private FragmentNotificationBinding(@NonNull ConstraintLayout rootView,
      @NonNull ImageView imgSadFace, @NonNull RecyclerView noificationListRecycler) {
    this.rootView = rootView;
    this.imgSadFace = imgSadFace;
    this.noificationListRecycler = noificationListRecycler;
  }
  ...
  public static FragmentNotificationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.noificationListRecycler;
      RecyclerView noificationListRecycler = rootView.findViewById(id);
      if (noificationListRecycler == null) {
        break missingId;
      }

      return new FragmentNotificationBinding((ConstraintLayout) rootView, imgSadFace,
          noificationListRecycler);
    }
