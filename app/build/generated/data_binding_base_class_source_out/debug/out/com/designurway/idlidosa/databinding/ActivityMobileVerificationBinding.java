...
public final class ActivityMobileVerificationBinding implements ViewBinding {
  ...
  private ActivityMobileVerificationBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityMobileVerificationBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityMobileVerificationBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_mobile_verification, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityMobileVerificationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMobileVerificationBinding((RelativeLayout) rootView, appLogoHere, curveBg,
          getOtpBtn, phoneEt, signInTv);
    }
