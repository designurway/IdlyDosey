...
public class LocationFragmentDirections {
  ...
  @NonNull
  public static ActionLocationFragmentToPaymentFragment actionLocationFragmentToPaymentFragment(
    ...
    return new ActionLocationFragmentToPaymentFragment(name, address, amount, phone, comboId, productId, orderId);
  }
  ...
  public static class ActionLocationFragmentToPaymentFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionLocationFragmentToPaymentFragment(@NonNull String name, @NonNull String address,
    ...
    @NonNull
    public ActionLocationFragmentToPaymentFragment setName(@NonNull String name) {
      if (name == null) {
        throw new IllegalArgumentException("Argument \"name\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("name", name);
    ...
    @NonNull
    public ActionLocationFragmentToPaymentFragment setAddress(@NonNull String address) {
      if (address == null) {
        throw new IllegalArgumentException("Argument \"address\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("address", address);
    ...
    @NonNull
    public ActionLocationFragmentToPaymentFragment setAmount(@NonNull String amount) {
      if (amount == null) {
        throw new IllegalArgumentException("Argument \"amount\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("amount", amount);
    ...
    @NonNull
    public ActionLocationFragmentToPaymentFragment setPhone(@NonNull String phone) {
      if (phone == null) {
        throw new IllegalArgumentException("Argument \"phone\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("phone", phone);
    ...
    @NonNull
    public ActionLocationFragmentToPaymentFragment setComboId(@NonNull String comboId) {
      if (comboId == null) {
        throw new IllegalArgumentException("Argument \"comboId\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("comboId", comboId);
    ...
    @NonNull
    public ActionLocationFragmentToPaymentFragment setProductId(@NonNull String productId) {
      if (productId == null) {
        throw new IllegalArgumentException("Argument \"productId\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("productId", productId);
    ...
    @NonNull
    public ActionLocationFragmentToPaymentFragment setOrderId(@NonNull String orderId) {
      if (orderId == null) {
        throw new IllegalArgumentException("Argument \"orderId\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("orderId", orderId);
    ...
    public int getActionId() {
      return R.id.action_locationFragment_to_paymentFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionLocationFragmentToPaymentFragment that = (ActionLocationFragmentToPaymentFragment) object;
    ...
    public String toString() {
      return "ActionLocationFragmentToPaymentFragment(actionId=" + getActionId() + "){"
          + "name=" + getName()
          + ", address=" + getAddress()
          + ", amount=" + getAmount()
          + ", phone=" + getPhone()
