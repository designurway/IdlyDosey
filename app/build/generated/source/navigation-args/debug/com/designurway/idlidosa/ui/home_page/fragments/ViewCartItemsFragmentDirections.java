...
public class ViewCartItemsFragmentDirections {
  private ViewCartItemsFragmentDirections() {
  }

  @NonNull
  public static ActionViewCartItemsFragmentToAddressBookFragment actionViewCartItemsFragmentToAddressBookFragment(
      @NonNull String amount, @NonNull String FromSetting, @NonNull String orderId) {
    return new ActionViewCartItemsFragmentToAddressBookFragment(amount, FromSetting, orderId);
  }
  ...
  public static class ActionViewCartItemsFragmentToAddressBookFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionViewCartItemsFragmentToAddressBookFragment(@NonNull String amount,
    ...
    @NonNull
    public ActionViewCartItemsFragmentToAddressBookFragment setAmount(@NonNull String amount) {
      if (amount == null) {
        throw new IllegalArgumentException("Argument \"amount\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("amount", amount);
    ...
    @NonNull
    public ActionViewCartItemsFragmentToAddressBookFragment setFromSetting(
    ...
    @NonNull
    public ActionViewCartItemsFragmentToAddressBookFragment setOrderId(@NonNull String orderId) {
      if (orderId == null) {
        throw new IllegalArgumentException("Argument \"orderId\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("orderId", orderId);
    ...
    public int getActionId() {
      return R.id.action_viewCartItemsFragment_to_addressBookFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionViewCartItemsFragmentToAddressBookFragment that = (ActionViewCartItemsFragmentToAddressBookFragment) object;
    ...
    public String toString() {
      return "ActionViewCartItemsFragmentToAddressBookFragment(actionId=" + getActionId() + "){"
          + "amount=" + getAmount()
