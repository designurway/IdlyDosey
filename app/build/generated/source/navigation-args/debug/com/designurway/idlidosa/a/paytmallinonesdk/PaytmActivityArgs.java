...
public class PaytmActivityArgs implements NavArgs {
  private final HashMap arguments = new HashMap();

  private PaytmActivityArgs() {
  }

  private PaytmActivityArgs(HashMap argumentsMap) {
    this.arguments.putAll(argumentsMap);
  }

  @NonNull
  @SuppressWarnings("unchecked")
  public static PaytmActivityArgs fromBundle(@NonNull Bundle bundle) {
    PaytmActivityArgs __result = new PaytmActivityArgs();
    bundle.setClassLoader(PaytmActivityArgs.class.getClassLoader());
  ...
  public boolean equals(Object object) {
    ...
    PaytmActivityArgs that = (PaytmActivityArgs) object;
  ...
  public static class Builder {
    ...
    public Builder(PaytmActivityArgs original) {
    ...
    @NonNull
    public PaytmActivityArgs build() {
      PaytmActivityArgs result = new PaytmActivityArgs(arguments);
      return result;
    }
